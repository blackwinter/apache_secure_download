...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/apache/secure_download/util.rb", "lib/apache/secure_download/version.rb", "lib/apache/secure_download.rb", "README", "ChangeLog", "Rakefile", "COPYING"]
  s.homepage = %q{http://prometheus.rubyforge.org/apache_secure_download}
  s.rdoc_options = ["--title", "apache_secure_download Application documentation", "--main", "README", "--line-numbers", "--inline-source", "--charset", "UTF-8", "--all"]
  s.require_paths = ["lib"]
